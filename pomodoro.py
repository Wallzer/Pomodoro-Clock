...
wether_text=canvas.create_text(190, 25, text=get_weather(), font=('Helvetica', 14), fill="black")
current_time=canvas.create_text(360, 580, text=get_time(), font=('Helvetica', 14), fill="white")
# Start the main loop
root.mainloop()